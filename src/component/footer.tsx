  ...
  return (
    <footer className="bg-gradient-to-br from-[#1f1f1f] to-[#0f0f0f] w-full text-gray-300 z-40 py-12 border-t border-gray-700">
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm leading-relaxed text-gray-400">
            Smart, secure & scalable Shopsyraa eCommerce platform built for
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm">shopsyraa@gmail.com</p>
          <p className="text-sm">+91 6398 XXXX XX</p>
      ...
      <div className="text-center text-xs text-gray-500 mt-12 border-t border-gray-700 pt-4">
        © {new Date().getFullYear()} Shopsyraa — Powered by Secure Commerce Engine
      </div>
    </footer>
  );
}
